...
def raise_alarm(connection, alarm):
    alarm_request_ip = 'http://10.10.10.10/control/rcontrol?action=sound&soundfile=Alarm'
...
if __name__ == '__main__':
    ...
    quality = "50"
    fps = "30.0"
    stream_ip=("http://10.10.10.10/control/faststream.jpg?stream=full&preview&previewsize="
